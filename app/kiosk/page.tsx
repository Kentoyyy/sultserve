    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="max-w-lg w-full text-center">
          ...
          <button 
            onClick={startOrder}
            className="w-full bg-emerald-600 text-white py-4 px-8 rounded-xl text-lg font-semibold hover:bg-emerald-700 transition-colors shadow-sm border border-emerald-600 hover:border-emerald-700"
          >
            Start Your Order
          </button>
